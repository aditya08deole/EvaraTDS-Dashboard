      ...
      <div className="w-full max-w-3xl relative z-10">
        ...
        <div className="text-center mb-10">
          <div className="flex justify-center gap-8 mb-10">
            <img src="/EvaraTech.png" alt="EvaraTech" className="h-32 w-auto object-contain drop-shadow-[0_0_6px_rgba(255,255,255,0.3)]" />
            <img src="/IIITH.png" alt="IIITH" className="h-32 w-auto object-contain drop-shadow-[0_0_6px_rgba(255,255,255,0.3)]" />
          </div>
