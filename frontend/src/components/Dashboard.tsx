...
const Dashboard = () => {
  ...
  return (
    <div className="p-3 lg:p-4 w-full h-screen flex flex-col space-y-2 overflow-hidden bg-gradient-to-br from-[#0B0F1A]/50 via-transparent to-[#161E2E]/30">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-2 flex-1 overflow-hidden relative">
        <div className="absolute -top-2 left-0 right-0 h-px bg-gradient-to-r from-transparent via-[#38BDF8]/30 to-transparent"></div>

        {/* Left: TDS Chart */}
        <div className="glass-card p-3 lg:p-4 rounded-xl flex flex-col">
          <h3 className="text-[#E5E7EB] font-black text-lg lg:text-xl mb-2 flex items-center gap-2">
            <Activity className="w-5 h-5 lg:w-6 lg:h-6 text-[#38BDF8]"/> TDS Trends (Last Hour)
          </h3>
        ...
        <div className="glass-card p-3 lg:p-4 rounded-xl flex flex-col">
          <h3 className="text-[#E5E7EB] font-black text-lg lg:text-xl mb-2 flex items-center gap-2">
            <Thermometer className="w-5 h-5 lg:w-6 lg:h-6 text-[#38BDF8]"/> Temperature Trends (Last Hour)
          </h3>
          <div className="w-full flex-1" style={{ minHeight: 0 }}>
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart data={chartData}>
