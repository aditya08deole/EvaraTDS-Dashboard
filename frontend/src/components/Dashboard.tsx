...
const Dashboard = () => {
  ...
  return (
    <div className="p-4 lg:p-6 w-full min-h-screen flex flex-col space-y-4 overflow-hidden bg-gradient-to-br from-[#0B0F1A]/50 via-transparent to-[#161E2E]/30">
      ...
      <div className="flex justify-between items-start">
        ...
        <div className="flex flex-col items-end gap-3">
          <div className="flex items-center gap-3">
            <img src="/EvaraTech.png" alt="EvaraTech" className="h-[52px] lg:h-[60px] w-auto object-contain" />
            <img src="/IIITH.png" alt="IIITH" className="h-[52px] lg:h-[60px] w-auto object-contain" />
          </div>
          <div className="flex items-center gap-2 text-[#9CA3AF] font-medium text-xs mt-4">
      ...
      {/* Alert Banner */}
      {isCritical ? (
        <div className="neon-alert p-4 rounded-xl flex items-center gap-3 shadow-xl w-full md:w-1/2 mx-auto">
        ...
        <div className="neon-alert p-4 rounded-xl flex items-center gap-3 shadow-lg border border-[#22C55E]/20 animate-pulse shadow-[0_0_20px_rgba(34,197,94,0.45)] w-full md:w-1/2 mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative items-stretch">
        ...
        <div className="h-44 lg:h-48"><StatCard 
          label="TDS" 
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 h-96 overflow-hidden relative">
