...
import { Activity, Settings as SettingsIcon, Database, LogOut, User } from 'lucide-react';
      ...
      <div className="relative flex min-h-screen">
        <aside className="w-72 border-r border-[#1F2937] bg-gradient-to-b from-[#0F172A]/90 via-[#0F172A]/80 to-[#0B0F1A]/70 backdrop-blur-xl hidden lg:flex flex-col p-6 z-10 shadow-2xl">
          ...
          <div className="mt-6 pt-6 border-t border-[#1F2937]">
            <div className="flex items-center gap-3 px-4 py-3 rounded-xl bg-[#161E2E]/50 mb-3">
            ...
            <button
              ...
              className="w-full flex items-center gap-3 px-5 py-3 rounded-xl bg-[#EF4444]/10 hover:bg-[#EF4444]/20 text-[#EF4444] border border-[#EF4444]/30 hover:border-[#EF4444]/50 transition-all font-bold group"
            >
